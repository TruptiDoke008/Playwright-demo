...
test('My Fisrt playwright test', async ({browser})=>
{
    ...
    console.log(await title.nth(0).textContent()); //o/p: iphone X
    //.nth(0) will return the first elemnet of the list bcz we total have 4 elemnets in the same css path.

    console.log(await title.nth(1).textContent()); //o/p:Samsung Note 8    

    console.log(await title.first().textContent());//o/p: iphone X
    //.first() return the 1st element of the list.
    console.log(await title.last().textContent());//o/p: Blackberry
